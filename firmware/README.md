...
|---|---|---|---|
| `codigo_robo_controle_p3/` | oficial + 2 mudanças | **EM USO no robô** | Pilotar com o controle: R2/L2 frente/trás, analógico direito direção, O/□/△ arma, setas (padrão = seta ↓), L3+R3 trava. As mudanças estão descritas no topo do `.ino` |
